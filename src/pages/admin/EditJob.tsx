  ...
  return (
    <div className="max-w-4xl mx-auto pb-12">
      <div className="mb-8">
        ...
        <p className="text-slate-500 mt-1">Update the details of your job.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="flex justify-end gap-4 pt-4">
          ...
          <button type="submit" disabled={loading} className="px-6 py-2.5 rounded-xl bg-blue-600 text-white font-medium hover:bg-blue-700 transition-colors disabled:opacity-50 flex items-center">
            {loading ? 'Updating...' : 'Update Job Advertisement'}
          </button>
        </div>
      </form>
    </div>
